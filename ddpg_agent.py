...
class Agent:
    ...
    def __init__(self, state_size, action_size, random_seed, params,
        ...
        self.lr_actor = params.lr_actor             # learning rate of the actor
        self.lr_critic = params.lr_critic           # learning rate of the critic
        self.tau = params.target_tau                # for soft update of target parameters
        self.weight_decay = params.weight_decay     # L2 weight decay
